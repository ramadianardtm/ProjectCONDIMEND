...
<body>
    <div class="w-10/12 ml-3 bg-white border border-gray-200 rounded-2xl shadow-md max-h-80vh overflow-auto p-4">
        <div class="row" style="justify-content: space-between;">
            ...
            <div class="col-sm-3 d-flex mr-4 bg-white border border-gray-200 shadow-md overflow-auto" style="height:70px;align-items:center;border-radius:10px;cursor:poi">
